...
# response = z.set_availability(channel_id="1", unit_id_z="10204823", room_id_z="1020482301", date_from=pd.Timestamp(day=28, month=7, year=2023), date_to=pd.Timestamp(day=29, month=7, year=2023), availability=1)
