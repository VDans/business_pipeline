...
class PriceLabs:
	def __init__(self, secrets, url="https://api.pricelabs.co/v1/integration/api"):
		...
		self.auth = H(self.secrets["pricelabs"]["X-INTEGRATION-NAME"], self.secrets["zodomus_prd"]["api_password"])
